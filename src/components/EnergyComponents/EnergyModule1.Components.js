            ...
            <div class="weaverz-ai-w-full weaverz-ai-overflow-hidden sm:weaverz-ai-w-full md:weaverz-ai-w-4/12 lg:weaverz-ai-w-4/12 xl:weaverz-ai-w-4/12 weaverz-ai-p-4">
              <div class="weaverz-ai-m-auto">
                <img
                  src={logo}
                  alt="productLogo"
                  class="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-m-auto sm:weaverz-ai-ml-0 weaverz-ai-mr-auto weaverz-ai-energy-logo"
                />
                <h5 class="weaverz-ai-font-opensans weaverz-ai-heading weaverz-ai-text-center sm:weaverz-ai-text-left">
                  {heading}
                </h5>
                <div class="weaverz-ai-flex weaverz-ai-value-group weaverz-ai-m-auto sm:weaverz-ai-ml-0">
              ...
              <div class="">
                <div class="weaverz-ai-flex weaverz-ai-flex-wrap">
                    {keyfeatures.map((value) => {
                      return (
                        <div class="weaverz-ai-energy-key-feature weaverz-ai-w-6/12">
