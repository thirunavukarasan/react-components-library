...
import "./EntityModule9.Components.css";
export const EntityModule9 = (props) => {
  const {
    heading,
    description,
    iconImage,
  ...
  return (
    <>
      <section id="weaveroo-entity-module-9">
        <div
          class="weaverz-ai-layout weaverz-ai-mx-auto weaverz-ai-relative weaverz-ai-samsung-sectwo"
        ...
        >
          <div class="weaverz-ai-container">
            <div class="md:weaverz-ai-flex weaverz-ai-items-center sm:weaverz-ai-block">
              <div class="md:weaverz-ai-w-7/12 sm:weaverz-ai-w-full weaverz-ai-mx-auto">
                <div class="weaverz-ai-samsung-sectwo-leftcontent">
                  <div class="weaverz-ai-samsung-sectwo-ico">
                    <img
                      src={iconImage}
                      srcSet={iconSrcSet}
                      sizes={iconSizes}
                      ...
                      class="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-samsung-sectwo-icon"
                    />
                  </div>
                  <h5 class="weaverz-ai-font-opensans weaverz-ai-samsung-sectwo-mainheading" style={{color : textColor, fontSize: HeadingfontSize}}>
                    {heading}
                  </h5>
                  <p class="weaverz-ai-font-opensans weaverz-ai-samsung-sectwo-pragraph" style={{color : textColor, fontSize: ParafontSize}}>
                    {description}
                  </p>
                </div>
              </div>
              <div class="md:weaverz-ai-w-5/12 sm:weaverz-ai-w-full weaverz-ai-pb-10">
                <div class="weaverz-ai-samsung-sectwo-imgsec">
                  <img
                    src={entityImage}
                    srcSet={entitySrcSet}
                    sizes={entitySizes}
                    alt={heading}
                    class="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-samsung-sectwo-productimg weaverz-ai-mx-auto"
                  />
                </div>
              </div>
            </div>
