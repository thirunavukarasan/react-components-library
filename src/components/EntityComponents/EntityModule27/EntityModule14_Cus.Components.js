...
import "./EntityModule14_Cus.Common.css";
import "./EntityModule14_Cus.Components.css";
export const EntityModule14_Cus = (props) => {
  const {
    heading,
    description,
    entityImage,
      ...
      <section class="weaver-ai-nike-shoe weaver-ai-p-0" data-comp-id={showCompId}>
          <div class="weaver-ai-container-fluid">
            <div class="weaver-ai-row weaver-ai-m-0">
              ...
              <div class="weaver-ai-col-xl-7 weaver-ai-col-lg-7 weaver-ai-col-sm-7 weaver-ai-shoe-bg weaverz-ai-p-0">
                <img
                  src={entityImage}
                  srcSet={entitySrcSet}
                  sizes={entitySizes}
...
EntityModule14_Cus.defaultProps = {
  showCompId: true,
