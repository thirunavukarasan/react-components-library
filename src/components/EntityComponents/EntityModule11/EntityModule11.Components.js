...
import "./EntityModule11.Components.css";
export const EntityModule11 = (props) => {
  const {
    heading,
    description,
    iconImage,
  ...
  return (
    <>
      <section id="weaveroo-entity-module-11">
        <div
          class="weaverz-ai-layout weaverz-ai-mx-auto weaverz-ai-relative weaverz-ai-samsung-secfour"
          ...
          <div class="weaverz-ai-container">
            <div class="md:weaverz-ai-flex weaverz-ai-items-center sm:weaverz-ai-block">
              <div class="md:weaverz-ai-w-7/12 sm:weaverz-ai-w-full weaverz-ai-mx-auto">
                <div class="weaverz-ai-samsung-secfour-leftcontent">
                  <div class="weaverz-ai-samsung-secfour-ico">
                    <img
                     src={iconImage}
                     srcSet={iconSrcSet}
                     sizes={iconSizes}
                     ...
                     style={styles.iconFilter}
                      class="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-samsung-secfour-icon"
                    />
                  </div>
                  <h5 class="weaverz-ai-font-opensans weaverz-ai-samsung-secfour-mainheading" style={{color : textColor, fontSize: HeadingfontSize}}>
                    {heading}
                  </h5>
                  <p class="weaverz-ai-font-opensans weaverz-ai-samsung-secfour-pragraph" style={{color : textColor, fontSize: ParafontSize}}>
                    {description}
                  </p>
                </div>
              </div>
              <div class="md:weaverz-ai-w-5/12 sm:weaverz-ai-w-full">
                <img
                  src={entityImage}
                  srcSet={entitySrcSet}
                  sizes={entitySizes}
                  alt={heading}
                  class="weaverz-ai-img-auto weaverz-ai-object-cover weaverz-ai-samsung-secfour-productimg weaverz-ai-ml-auto weaverz-ai-object-center"
                />
              </div>
            </div>
          </div>
