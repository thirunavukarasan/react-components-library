...
import "./DoubleEntityModule2.css";
export const DoubleEntityModule2 = (props) => {
            ...
            <div className="weaverz-ai-container">
              <div className="md:weaverz-ai-flex sm:weaverz-ai-block">
                {entitySet.map((entityInfo, i) => {
                  return (
                    <div
                      className={`md:weaverz-ai-w-6/12 sm:weaverz-ai-w-full ${
                        i === 0 ? "md:weaverz-ai-mr-4" : "md:weaverz-ai-ml-4"
                      }`}
                    ...
                    >
                      <div className="weaverz-ai-productitems">
                        <img
                          ...
                          alt={entityInfo.name}
                          className="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-FridgeSection10-productimg weaverz-ai-mr-auto"
                        />
...
DoubleEntityModule2.defaultProps = {
  showCompId: true,
  entitySet: [
    {
      name: "entiyname1",
