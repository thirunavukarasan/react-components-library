...
import "./EntityModule7.Components.css";
export const EntityModule7 = (props) => {
  const {
    heading,
    description,
    iconImage,
  ...
  return (
    <>
      <section id="weaveroo-entity-module-7">
        <div
          className="weaverz-ai-layout weaverz-ai-mx-auto weaverz-ai-relative weaverz-ai-FridgeSection3"
              ...
              <div className="md:weaverz-ai-w-7/12 sm:weaverz-ai-w-full">
                <div className="weaverz-ai-FridgeSection2-imgsec">
                  <img
                    ...
                    sizes={entitySizes}
                    alt={heading}
                    className="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-FridgeSection3-productimg"
                  />
                </div>
              </div>

              <div className="md:weaverz-ai-w-6/12 sm:weaverz-ai-w-full">
                <div className="weaverz-ai-FridgeSection3-squarebox weaverz-ai-ml-auto">
                  <div className="weaverz-ai-FridgeSection3-fridge-ico2">
                    <img
                     src={iconImage}
                     srcSet={iconSrcSet}
                     sizes={iconSizes}
                     ...
                     style={styles.iconFilter}
                      className="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-FridgeSection3-icon"
                    />
                  </div>
                  <h5 className="weaverz-ai-font-opensans weaverz-ai-FridgeSection3-secondaryheading" style={{color : textColor, fontSize: HeadingfontSize}}>
                    {heading}
                  </h5>
                  <p className="weaverz-ai-font-opensans weaverz-ai-FridgeSection3-pragraph" style={{color : textColor, fontSize: ParafontSize}}>
                    {description}
                  </p>
                </div>
              </div>
