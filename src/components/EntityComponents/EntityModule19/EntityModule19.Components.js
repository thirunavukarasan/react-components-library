...
import "./EntityModule19.Common.css";
import "./EntityModule19.Components.css";
export const EntityModule19 = (props) => {
  const {
    heading,
    description,
    entityImage,
  ...
  const styles = {
    bg: {
      backgroundColor: bgColor ? bgColor : "#292929",
    },
  };
  return (
    <>
      <div id="weaveroo-entity-module-19">
        <section
          class="weaver-ai-coloravaliable-wrap"
          ...
          <div class="weaver-ai-container-fluid">
            <div class="weaver-ai-row weaver-ai-align-items-center">
              <div class="weaver-ai-col-xl-6 weaver-ai-col-lg-6 weaver-ai-col-sm-6">
                <div class="weaver-ai-coloravaliable-imgsec weaver-ai-d-flex">
                  <img
                    src={entityImage}
                    srcSet={entitySrcSet}
                    sizes={entitySizes}
                    class="weaver-ai-cavaliable-leftimg weaver-ai-color-avaliable-img"
                  />
                  <img
                    src={entityImage}
                    srcSet={entitySrcSet}
                    sizes={entitySizes}
                    class="weaver-ai-cavaliable-rightimg weaver-ai-color-avaliable-img"
                  />
                </div>
              </div>
              <div class="weaver-ai-col-xl-6 weaver-ai-col-lg-6 weaver-ai-pt-5 weaver-ai-mt-2 weaver-ai-pl-5 weaver-ai-col-sm-6">
                <div class="weaver-ai-cavaliable-rightbg">
                  <h6>{heading}</h6>
                  <p>{description} </p>
                </div>
              </div>
