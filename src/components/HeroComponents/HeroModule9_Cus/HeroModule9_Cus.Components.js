...
import "./HeroModule9_CusComponents.css";
export const Hero9_Cus = (props) => {
  const {
    name,
    tagLine,
    heroImage,
  ...
  return (
    <>
      <div id="weaveroo-hero-module-9_Cus">
        <div
          ...
          <div className=" sm:weaverz-ai-col-start-2 md:weaverz-ai-col-start-3 weaverz-ai-col-span-2">
            ...
            <span>
              <h6
                ...
                style={{fontSize: HeadingfontSize ? `${HeadingfontSize}px` :  "30px" , color: textColor}}
              >
                {name}
              </h6>
              <p
                className={`weaverz-ai-text-center weaverz-ai-font-Helvetica weaverz-ai-text-sm`}
                style={{fontSize: ParafontSize ? `${ParafontSize}px` :  "20px" , color: textColor}}
              >
                {tagLine}
              </p>
            </span>
