...
import "./BrandModule2.Components.scss";
export const BrandModule2 = (props) => {
  const { image, logo, text, productName, category } = props;
  return (
    <>
      <section
        id="weaveroo-brand-module-2"
      ...
      >
        <div className="weaverz-ai-container">
          <div className="weaverz-ai-flex weaverz-ai-flex-wrap weaverz-ai-overflow-hidden">
            <div className="weaverz-ai-flex weaverz-ai-flex-wrap weaverz-ai-w-full weaverz-ai-overflow-hidden sm:weaverz-ai-w-full md:weaverz-ai-w-6/12 lg:weaverz-ai-w-6/12 xl:weaverz-ai-w-6/12 weaverz-ai-text-center weaverz-ai-brand-section">
              <div className="weaverz-ai-w-full weaverz-ai-overflow-hidden weaverz-ai-self-center weaverz-ai-brand-items">
                <img
                  src={logo}
                  alt="productLogo"
                  className="weaverz-ai-img-auto weaverz-ai-object-contain weaverz-ai-mx-auto weaverz-ai-py-2"
                />
                <h5>
            ...
            <div className="weaverz-ai-w-full weaverz-ai-overflow-hidden sm:weaverz-ai-w-full md:weaverz-ai-w-6/12 lg:weaverz-ai-w-6/12 xl:weaverz-ai-w-6/12 weaverz-ai-brand-side">
              <img
                src={image}
                alt="side-image"
