      ...
      >
        {orientation === "r" ? (
          <div class="weaverz-ai-flex weaverz-ai-flex-wrap weaverz-ai-overflow-hidden">
            <div class="weaverz-ai-flex weaverz-ai-flex-wrap weaverz-ai-w-full weaverz-ai-overflow-hidden weaverz-ai-mt-0 md:weaverz-ai-mt-2 weaverz-ai-mb-2 md:weaverz-ai-pl-2 md:weaverz-ai-w-2/5 lg:weaverz-ai-w-2/5 xl:weaverz-ai-w-2/5">
              {entitySet.map((data) => {
                return (
                  <div class="weaverz-ai-w-full md:weaverz-ai-w-full weaverz-ai-overflow-hidden weaverz-ai-mb-2">
                    <img
            ...
            <div class="weaverz-ai-w-full weaverz-ai-overflow-hidden sm:weaverz-ai-my-0 md:weaverz-ai-my-2 md:weaverz-ai-px-2 md:weaverz-ai-w-3/5 lg:weaverz-ai-w-3/5	xl:weaverz-ai-w-3/5">
              <img
          ...
          <div class="weaverz-ai-flex weaverz-ai-flex-wrap weaverz-ai-overflow-hidden">
            <div class="weaverz-ai-w-full weaverz-ai-overflow-hidden weaverz-ai-mt-0 md:weaverz-ai-mt-2 weaverz-ai-mb-2 md:weaverz-ai-px-2 md:weaverz-ai-w-6/12 lg:weaverz-ai-w-6/12 xl:weaverz-ai-w-6/12">
              <img
                src={mainImage.entityImage}
                srcSet={mainImage.entitySrcSet}
                sizes={mainImage.entitySizes}
              ...
              <div class="weaverz-ai-w-full weaverz-ai-overflow-hidden weaverz-ai-mt-2 weaverz-ai-px-2 md:weaverz-ai-px-0">
                <h1 style={styles.heading} className="head">
                  {heading}
                </h1>
                <p style={styles.para} className="des">
            ...
            <div class="weaverz-ai-w-full weaverz-ai-overflow-hidden weaverz-ai-mt-0 md:weaverz-ai-mt-2  md:weaverz-ai-pr-2 md:weaverz-ai-w-6/12 lg:weaverz-ai-w-6/12	xl:weaverz-ai-w-6/12">
              {entitySet.map((data) => {
                return (
                  <div class="weaverz-ai-w-full weaverz-ai-overflow-hidden md:weaverz-ai-mb-2">
                    <img
                      src={data.entityImage}
                      srcSet={data.entitySrcSet}
                      sizes={data.entitySizes}
