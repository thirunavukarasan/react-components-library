...
import {DoubleEntityModule1} from "../../components/EntityComponents";

export default {
  title: "Weaveroo/Entity Modules/Double/Entity Module1",
  component: DoubleEntityModule1,
};

const Template = (args) => <DoubleEntityModule1 {...args} />;
