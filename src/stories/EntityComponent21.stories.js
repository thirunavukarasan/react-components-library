...
import { EntityModule21 } from "../components/EntityComponents/EntityModule21/EntityModule21.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module21",
  component: EntityModule21,
};

const Template = (args) => <EntityModule21 {...args} />;
