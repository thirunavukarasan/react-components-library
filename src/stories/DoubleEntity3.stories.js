...
import { DoubleEntityModule3 } from "../components/EntityComponents/Double/DoubleEntityModule3/EntityModule3.Components";

export default {
  title: "Weaveroo/Entity Modules/Double/Entity Module3",
  component: DoubleEntityModule3,
};

const Template = (args) => <DoubleEntityModule3 {...args} />;
