...
import { EntityModule24 } from "../../components/EntityComponents/EntityModule24/EntityModule24.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module24",
  component: EntityModule24,
};

const Template = (args) => <EntityModule24 {...args} />;
