...
import { EntityModule22 } from "../../components/EntityComponents/EntityModule22/EntityModule22.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module22",
  component: EntityModule22,
};

const Template = (args) => <EntityModule22 {...args} />;
