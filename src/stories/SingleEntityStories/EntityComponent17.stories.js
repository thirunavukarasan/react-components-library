...
import { EntityModule17 } from "../../components/EntityComponents/EntityModule17/EntityModule17.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module17",
  component: EntityModule17,
};

const Template = (args) => <EntityModule17 {...args} />;
