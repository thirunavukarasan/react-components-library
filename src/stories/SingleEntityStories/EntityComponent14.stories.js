...
export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module14",
  component: EntityModule14,
};

const Template = (args) => <EntityModule14 {...args} />;

export const EntityModule14Default = Template.bind({});
EntityModule14Default.args = {
  showCompId: true,
