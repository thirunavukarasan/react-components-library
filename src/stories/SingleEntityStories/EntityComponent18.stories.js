...
import { EntityModule18 } from "../../components/EntityComponents/EntityModule18/EntityModule18.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module18",
  component: EntityModule18,
};

const Template = (args) => <EntityModule18 {...args} />;
