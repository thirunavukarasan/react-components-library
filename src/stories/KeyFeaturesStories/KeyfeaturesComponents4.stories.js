...
import { KeyfeaturesModule4 } from "../../components/KeyfeaturesComponents/Keyfeatures4/KeyfeaturesModule4.Components";

export default {
  title: "Weaveroo/Keyfeatures Modules/Keyfeatures Module4",
  component: KeyfeaturesModule4,
};

const Template = (args) => <KeyfeaturesModule4 {...args} />;
