...
import {EntityModule3} from "../components/EntityComponents/EntityModule3/EntityModule3.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module3",
  component: EntityModule3,
};

const Template = (args) => <EntityModule3 {...args} />;
