...
import { CollageModule1FourImg } from "./CollageModuleStories/CollageModule1.stories";
...
export default {
  ...
  title: "Template/Tempate 3",
};

const templateDesign2 = ({
  ContaineItem,
  HeroItem,
  Collage1Item,
  Entity14Item_Cus,
  ...
  Collage1Item.textSectionIshow = false,
  ColageRightItem.textSectionIshow = false,
  Colage1ItemFourImg.textSectionIshow = false
  return (
    <Container {...ContaineItem}>
      ...
      <CollageModule1 {...Colage1ItemFourImg} />
...
Default.args = {
  ...
  Colage1ItemFourImg: CollageModule1FourImg.args,
