...
import {EntityModule13} from "../components/EntityComponents/EntityModule13/EntityModule13.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module13",
  component: EntityModule13,
};

const Template = (args) => <EntityModule13 {...args} />;
