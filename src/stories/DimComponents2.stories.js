...
import {DimensionModule2} from "../components/DimComponents/Dimension2/Dimension2";

export default {
  title: "Weaveroo/Dimension Modules/Dimension Module2",
  component: DimensionModule2,
};

const Template = (args) => <DimensionModule2 {...args} />;
...
Default.args = {
  ...
  sideImg : "http://weaver-ai-template-syndication-poc.s3-website.ap-south-1.amazonaws.com/static/electric_ceramic_2-4d0f52657ecd685661ae7e4e8f233284.png",
  color : "Silver & black",
  Height : "900 mm",
  Width : "600 mm",
  Depth : "600 mm"
