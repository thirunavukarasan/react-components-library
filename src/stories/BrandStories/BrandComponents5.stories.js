...
import {BrandModule5} from "../../components/BrandComponents/BrandModule5/BrandModule5.Components";

export default {
  title: "Weaveroo/Brand Modules/Brand Module5",
  component: BrandModule5,
};

const Template = (args) => <BrandModule5 {...args} />;
