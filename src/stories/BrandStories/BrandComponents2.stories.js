...
import { BrandModule2 } from "../../components/BrandComponents/BrandModule2/BrandModule2.Components";

export default {
  title: "Weaveroo/Brand Modules/Brand Module2",
  component: BrandModule2,
};

const Template = (args) => <BrandModule2 {...args} />;
