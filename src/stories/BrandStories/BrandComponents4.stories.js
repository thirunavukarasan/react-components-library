...
import {BrandModule4} from "../../components/BrandComponents/BrandModule4/BrandModule4.Components";

export default {
  title: "Weaveroo/Brand Modules/Brand Module4",
  component: BrandModule4,
};

const Template = (args) => <BrandModule4 {...args} />;
