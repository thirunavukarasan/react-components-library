...
import {BrandModule6} from "../../components/BrandComponents/BrandModule6/BrandModule6.Components";

export default {
  title: "Weaveroo/Brand Modules/Brand Module6",
  component: BrandModule6,
};

const Template = (args) => <BrandModule6 {...args} />;
