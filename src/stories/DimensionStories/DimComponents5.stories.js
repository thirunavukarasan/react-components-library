...
import {DimensionModule5} from "../../components/DimComponents/Dimension5/Dimension5";

export default {
  title: "Weaveroo/Dimension Modules/Dimension Module5",
  component: DimensionModule5,
};

const Template = (args) => <DimensionModule5 {...args} />;
