...
import {EntityModule12} from "../components/EntityComponents/EntityModule12/EntityModule12.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module12",
  component: EntityModule12,
};

const Template = (args) => <EntityModule12 {...args} />;
