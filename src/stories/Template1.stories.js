...
const TjoriTemplate = ({ ContaineItem,HeroItem,Collage1Item,Entity14Item,BranPoliyItem, ...args }) => (
  ...
  Default.args = { 
    ...
    Collage1Item:CollageModule1Default.args,
    Entity14Item:EntityModule14Default.args,
