...
import {EntityModule4} from "../components/EntityComponents/EntityModule4/EntityModule4.Components";

export default {
  title: "Weaveroo/Entity Modules/Single/Entity Module4",
  component: EntityModule4,
};

const Template = (args) => <EntityModule4 {...args} />;
